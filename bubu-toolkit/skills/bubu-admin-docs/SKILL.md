...
Admin-docs-specific additions:

- Also banned in correspondence: "please be advised", "herein", "as per our conversation".
- No passive voice.
- Tone is authoritative but clear. A surat resmi should read like it was written by a seasoned professional, not generated by a machine, and formality must match the document type (surat resmi above memo).
